                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        foreach ($arrPersona as $persona){
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $persona->getTipoPerfil(); ?></td>
                                                <td><?php echo $persona->getEstado(); ?></td>
                                                <td>
                                                    <a href="editarpersona.php?id=<?php echo $persona->getIdPersona(); ?>" type="button" data-toggle="tooltip" title="Actualizar" class="btn docs-tooltip btn-primary btn-xs"><i class="fa fa-edit"></i></a>
